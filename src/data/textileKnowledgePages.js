export const TEXTILE_KNOWLEDGE_PAGES = [
  {
    ...
    fabricFamilies: ["single-jersey", "interlock", "cotton-knit"],
    processFamilies: ["knitting", "finishing", "washing"],
    riskSignals: ["shrinkage", "spirality", "hand-feel-variation"],
    buyerJourneyStage: "fabric-selection",
  ...
  },
  {
    ...
    fabricFamilies: ["cotton-knit", "single-jersey"],
    yarnFamilies: ["compact-cotton", "combed-cotton"],
    processFamilies: ["spinning", "knitting", "finishing"],
    riskSignals: ["pilling", "hand-feel-variation", "surface-clarity"],
    buyerJourneyStage: "quality-evaluation",
...
},
{
  ...
  fabricFamilies: ["single-jersey", "cotton-knit"],
  processFamilies: ["compacting", "finishing", "washing"],
  riskSignals: ["spirality", "shrinkage", "torque"],
  buyerJourneyStage: "production-evaluation",
  tags: [
    "spirality",
    "single jersey",
    "knitted fabric",
